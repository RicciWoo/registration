...
with Xvfb() as xvfb:
	...
	ax[0, 0].imshow(axial[:, :, 0])
	ax[0, 0].set_title('axial_x')
	ax[0, 1].imshow(axial[:, :, 1])
	ax[0, 1].set_title('axial_y')
	ax[0, 2].imshow(axial[:, :, 2])
	ax[0, 2].set_title('axial_z')
	ax[1, 0].imshow(coronal[:, :, 0])
	ax[1, 0].set_title('coronal_x')
	ax[1, 1].imshow(coronal[:, :, 1])
	ax[1, 1].set_title('coronal_y')
	ax[1, 2].imshow(coronal[:, :, 2])
	ax[1, 2].set_title('coronal_z')
	ax[2, 0].imshow(sagittal[:, :, 0])
	ax[2, 0].set_title('sagittal_x')
	ax[2, 1].imshow(sagittal[:, :, 1])
	ax[2, 1].set_title('sagittal_y')
	ax[2, 2].imshow(sagittal[:, :, 2])
